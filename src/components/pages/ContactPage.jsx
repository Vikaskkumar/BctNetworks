              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+9116141401" className="text-sm font-extrabold text-gray-800 dark:text-slate-200 hover:text-[#E51D25] dark:hover:text-red-400 mt-1 block transition-colors">
                      +91 9116141401
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:Sales@bctnetworks.in" className="text-sm font-extrabold text-gray-800 dark:text-slate-200 hover:text-[#E51D25] dark:hover:text-red-400 mt-1 block transition-colors">
